...
#
  gw_head_INI	 =   results\gw_headd.ini			;		# +m 		result of steady state groundwater model
#
...
# adding the RCH package
  RCH = cover((R3-ADDQ3)*CELLAREA/(3000*3000),scalar(0))		;		# USED
# RCH = cover((R3      )*CELLAREA/(3000*3000),scalar(0))		;		# used in the steady-state MODFLOW (the previous script) 
