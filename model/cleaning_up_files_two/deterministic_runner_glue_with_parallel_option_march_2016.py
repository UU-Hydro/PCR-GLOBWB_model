...
class DeterministicRunner(DynamicModel):
    ...
    def dynamic(self):
        ...
        # at the last day of the month, stop calculation until the modflow calculation is ready (only for a run with modflow) 
        if self.modelTime.isLastDayOfMonth() and self.configuration.online_coupling_between_pcrglobwb_and_moflow:
            ...
            # TODO: wait also until netcdf merging processes are done (also for runs without MODFLOW)
