...
class LandSurface(object):
    ...
    def update(self,meteo,groundwater,routing,currTimeStep):
        ...
        # update/calculate hydro processes (loop per each land cover type):
        for coverType in self.coverTypes:
        ...
        # calculate irrigation water demand (for the next time step)
        # self.calculate_irrigation_water_demand()
...
#    def calculate_irrigation_water_demand(self):
