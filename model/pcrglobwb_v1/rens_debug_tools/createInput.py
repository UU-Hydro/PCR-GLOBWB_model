...
cellLength= 0.5
domainName=  'Niger_2.0'
boundingBox= [( -11.5000000,   4.0000000),(  15.5000000,  20.5000000)]
...
initialPath= '/scratch/edwin/debug30min_after08Feb2014/global_2.0_initial_conditions/states'
#~ sourcePath= '/scratch/edwin/debug30min'
sourcePath= '/scratch/edwin/debug30min_after08Feb2014'
targetPath= '/scratch/rens/debug30min'
...
dynamicDataSets['temperature']= pcrObject('temperature',\
	os.path.join(targetPath,domainName,'meteo%YEAR','ta000000.%JULDAY'),\
	 '/data/hydroworld/forcing/CRU/crucor_era40_1957-2002_temperature.nc',\
...
dynamicDataSets['precipitation']= pcrObject('precipitation',\
	...
	'/data/hydroworld/forcing/CRU/crucor_era40_1957-2002_precipitation.nc',\
	boundingBox,cellLength,startDate,endDate,'days','scalar',dynamic)
dynamicDataSets['potentialEvapotranspiration']= pcrObject('potentialEvapotranspiration',\
	...
	'/data/hydroworld/forcing/CRU/crucor_era40_1957-2002_evapotranspiration.nc',\
	boundingBox,cellLength,startDate,endDate,'days','scalar',dynamic)
#-land cover
