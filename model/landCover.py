    ...
    def calculateWaterDemand(self, parameters, \
        ...
        if self.limitAbstraction == False:                              # TODO: For runs without any water use, we can exclude this. 
            ...
            correctedRemainingIrrigationLivestock = \
             ...
             pcr.max(0.0, totalIrrigationLivestockDemand) * (1.0 - swAbstractionFractionDict['irrigation'] - satisfiedIrrDemandFromNonFossilGroundwater)
            ...
            prioritizeFossilGroundwaterForDomesticIndutrial = True                                # TODO: Define this in 
