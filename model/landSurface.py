...
class LandSurface(object):
    ...
    def calculateCapRiseFrac(self,groundwater,routing,currTimeStep):
        ...
        CRFRAC = pcr.ifthenelse(dzGroundwater<self.soil_topo_parameters.['default'].dzRel0090,0.9 -(self.soil_topo_parameters['default'].dzRel0090-dzGroundwater)*0.1 /pcr.max(1e-3,self.soil_topo_parameters['default'].dzRel0090-self.soil_topo_parameters['default'].dzRel0090),CRFRAC);
        #~ CRFRAC = pcr.ifthenelse(dzGroundwater<self.soil_topo_parameters.['default'].dzRel0080,0.8 -(self.soil_topo_parameters['default'].dzRel0080-dzGroundwater)*0.1 /pcr.max(1e-3,self.soil_topo_parameters['default'].dzRel0080-self.soil_topo_parameters['default'].dzRel0070),CRFRAC);
        #~ CRFRAC = pcr.ifthenelse(dzGroundwater<self.soil_topo_parameters.['default'].dzRel0070,0.7 -(self.soil_topo_parameters['default'].dzRel0070-dzGroundwater)*0.1 /pcr.max(1e-3,self.soil_topo_parameters['default'].dzRel0070-self.soil_topo_parameters['default'].dzRel0060),CRFRAC);
        #~ CRFRAC = pcr.ifthenelse(dzGroundwater<self.soil_topo_parameters.['default'].dzRel0060,0.6 -(self.soil_topo_parameters['default'].dzRel0060-dzGroundwater)*0.1 /pcr.max(1e-3,self.soil_topo_parameters['default'].dzRel0060-self.soil_topo_parameters['default'].dzRel0050),CRFRAC);
        #~ CRFRAC = pcr.ifthenelse(dzGroundwater<self.soil_topo_parameters.['default'].dzRel0050,0.5 -(self.soil_topo_parameters['default'].dzRel0050-dzGroundwater)*0.1 /pcr.max(1e-3,self.soil_topo_parameters['default'].dzRel0050-self.soil_topo_parameters['default'].dzRel0040),CRFRAC);
        #~ CRFRAC = pcr.ifthenelse(dzGroundwater<self.soil_topo_parameters.['default'].dzRel0040,0.4 -(self.soil_topo_parameters['default'].dzRel0040-dzGroundwater)*0.1 /pcr.max(1e-3,self.soil_topo_parameters['default'].dzRel0040-self.soil_topo_parameters['default'].dzRel0030),CRFRAC);
        #~ CRFRAC = pcr.ifthenelse(dzGroundwater<self.soil_topo_parameters.['default'].dzRel0030,0.3 -(self.soil_topo_parameters['default'].dzRel0030-dzGroundwater)*0.1 /pcr.max(1e-3,self.soil_topo_parameters['default'].dzRel0030-self.soil_topo_parameters['default'].dzRel0020),CRFRAC);
