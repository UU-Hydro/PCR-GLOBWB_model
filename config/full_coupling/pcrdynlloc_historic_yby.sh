...
PCRGLOBWB_INITIAL_STATE_FOLDER="/gpfs/work3/0/prjs1311/qualloc/data/initial/historic/pcrglobwb"
...
# merge outputs
sbatch ${MERGE_NETCDF_PY} ${PCRGLOBWB_MODEL_SCRIPT_FOLDER} ${QUALLOCr_OUTPUT_DIR} ${QUALLOC_OUTPUT_NETCDF_DIR} out_month_avgNC ${START_YEAR}-01-01 ${END_YEAR}-12-01 ${QUALLOC_OUTPUT_NETCDFS} True &
