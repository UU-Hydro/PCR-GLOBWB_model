...
python parallel_pcrglobwb_runner.py ../config/05min_runs_2016_october/4LCs_ipsl-cm5a-lr/rcp8p5/begin_from_2006/setup_05min_ipsl-cm5a-lr_rcp4p5_begin_from_2006_part_two.ini
