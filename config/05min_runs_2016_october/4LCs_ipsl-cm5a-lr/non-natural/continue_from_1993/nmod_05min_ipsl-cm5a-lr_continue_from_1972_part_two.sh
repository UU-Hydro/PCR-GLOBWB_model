...
python parallel_pcrglobwb_runner.py ../config/05min_runs_2016_october/4LCs_ipsl-cm5a-lr/non-natural/continue_from_1993/setup_05min_ipsl-cm5a-lr_continue_from_1993_part_two.ini
