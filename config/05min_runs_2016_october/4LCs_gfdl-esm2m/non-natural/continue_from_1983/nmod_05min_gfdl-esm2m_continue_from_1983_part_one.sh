...
python parallel_pcrglobwb_runner.py ../config/05min_runs_2016_october/4LCs_gfdl-esm2m/non-natural/continue_from_1983/setup_05min_gfdl-esm2m_continue_from_1983_part_one.ini
