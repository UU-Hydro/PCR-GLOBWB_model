...
python parallel_pcrglobwb_runner.py ../config/05min_runs_2016_october/4LCs_gfdl-esm2m/rcp4p5/continue_from_2055/setup_05min_gfdl-esm2m_rcp4p5_continue_from_2055_part_two.ini
