...
python parallel_pcrglobwb_runner.py ../config/05min_runs_2016_october/4LCs_miroc-esm-chem/non-natural/continue_from_1960/setup_05min_miroc-esm-chem_continue_from_1960_part_one.ini
