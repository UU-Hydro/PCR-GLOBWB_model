...
#SBATCH -J 05min_natural_accutraveltime_part_one_using_a_consistent_pcraster_as_used_in_gmd_paper
...
python parallel_pcrglobwb_runner.py ../config/gmd_paper/05min/rerun_using_consistent_pcraster/natural/begin_from_1958/setup_05min_natural_parallel_part_one.ini
