...
python parallel_pcrglobwb_runner.py ../config/4LCs_edwin_parameter_set_kinematicwave_without_modflow_miroc-esm-chem/non-natural/continue_from_1967/setup_05min_miroc-esm-chem_pcrglobwb_4_land_covers_edwin_parameter_set_kinematicwave_continue_from_1967_part_one.ini
