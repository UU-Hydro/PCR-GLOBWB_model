...
python parallel_pcrglobwb_runner.py ../config/05min_example_with_modflow/online_coupling/setup_05min_cru-ts3.23_era-20C_pcrglobwb_with_modflow_4_land_covers_test_part_one.ini
