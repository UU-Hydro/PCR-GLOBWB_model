...
python parallelPCR-GLOBWB_without_prefactors.py ../config/05min_runs_january_2016/setup_05min_pcrglobwb_only_cartesius_parallel_natural_kinematic_wave_continue_from_1972.ini no_debug
