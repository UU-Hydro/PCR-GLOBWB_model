...
# - historical
INI_FILE=${INI_FOLDER}/"setup_05min_aquedut_on_eejit_pm.ini"
#~ # - ssp370
...
MAIN_OUTPUT_DIR="/scratch/depfg/sutan101/test_pm_pcrglobwb2_output_05min_global/aqueuduct_new-pmhistorical/begin_from_1960/"
#~ # - ssp370
