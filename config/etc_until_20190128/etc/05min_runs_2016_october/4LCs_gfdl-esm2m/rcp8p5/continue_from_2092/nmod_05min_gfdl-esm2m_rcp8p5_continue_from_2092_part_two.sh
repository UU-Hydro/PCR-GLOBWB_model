...
python parallel_pcrglobwb_runner.py ../config/05min_runs_2016_october/4LCs_gfdl-esm2m/rcp8p5/continue_from_2092/setup_05min_gfdl-esm2m_rcp8p5_continue_from_2092_part_two.ini
