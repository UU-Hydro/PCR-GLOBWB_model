...
# ini files
#~ # - with slurm
#~ INI_FILE=${SLURM_SUBMIT_DIR}"/setup_30sec_europe_with_05min_forcing_version_2021-06-XX_parallelization_with_clone_and_landmask_2017-2019.ini"
# - with bash
INI_FILE=$(pwd)"/setup_30sec_europe_with_05min_forcing_version_2021-06-XX_parallelization_with_clone_and_landmask_2017-2019.ini"
...
GENERAL_OUTPUT_DIR="/scratch-shared/edwin/pcrglobwb_output_europe_version_2021-06-XX/europe_30sec_with_05min_forcing_all_europe/continue_from_2017/"
