...
python parallel_pcrglobwb_runner.py ../config/05min_runs_2016_october/4LCs_noresm1-m/rcp4p5/begin_from_2006/setup_05min_noresm1-m_rcp4p5_begin_from_2006_part_two.ini
