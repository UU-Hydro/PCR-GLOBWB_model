...
python parallel_pcrglobwb_runner.py ../config/05min_runs_2016_october/4LCs_gfdl-esm2m/rcp8p5/begin_from_2006/setup_05min_gfdl-esm2m_rcp8p5_begin_from_2006_part_one.ini
