...
JOB_NAME="chrp_ac"
INI_FILE="setup_05min_africa_version_chirps_accutraveltime.ini"
GENERAL_MAIN_OUTPUT_DIR="/rds/general/user/esutanud/projects/arise/live/HydroModelling/edwin/pcrglobwb_output_africa/version_2021-07-XX/africa_05min/chirps_accutraveltime/"
STARTING_YEAR=1981
END_YEAR=2019
