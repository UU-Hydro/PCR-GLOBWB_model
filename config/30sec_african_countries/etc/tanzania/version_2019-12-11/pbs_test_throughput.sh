...
python deterministic_runner.py ../config/30sec_african_countries/tanzania/version_20191211/setup_30sec_tanzania-basin_test_version_2019_12_11_rerun_throughput.ini debug
