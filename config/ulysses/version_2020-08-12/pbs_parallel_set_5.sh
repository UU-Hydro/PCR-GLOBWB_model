...
python3 deterministic_runner_parallel_for_ulysses.py ${INI_FILE} debug_parallel 15 &
python3 deterministic_runner_parallel_for_ulysses.py ${INI_FILE} debug_parallel 37 &
