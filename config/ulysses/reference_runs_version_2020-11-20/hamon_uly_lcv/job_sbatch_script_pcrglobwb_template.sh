...
INI_FILE=${SLURM_SUBMIT_DIR}/"setup_6arcmin_hamon-et0_uly-lcv.ini"

# set the output folder
#~ MAIN_OUTPUT_DIR="/scratch/ms/copext/cyes/test_monthly_runs_develop/"
MAIN_OUTPUT_DIR="/scratch/depfg/sutan101/pcrglobwb_ulysses_reference_runs_version_2020-11-20/hamon-et0_uly-lcv/begin_from_1981/"
