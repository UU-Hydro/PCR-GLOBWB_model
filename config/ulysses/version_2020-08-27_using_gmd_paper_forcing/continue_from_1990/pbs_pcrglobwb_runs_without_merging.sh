#!/bin/bash 
#PBS -N uly-gmd-forcing-1990-2015
#PBS -q np
#PBS -l EC_nodes=3
...
INI_FILE=${PBS_O_WORKDIR}/setup_6arcmin_using_gmd_paper_forcing.ini


# set the output folder
MAIN_OUTPUT_DIR="/scratch/ms/copext/cyes/pcrglobwb_output_version_2020-08-27_using_gmd_paper_forcing/continue_from_1990/"
...
MAIN_INITIAL_STATE_FOLDER="/scratch/ms/copext/cyes/pcrglobwb_output_version_2020-08-27_using_gmd_paper_forcing/begin_from_1981/global/states/"
DATE_FOR_INITIAL_STATES=1989-12-31
