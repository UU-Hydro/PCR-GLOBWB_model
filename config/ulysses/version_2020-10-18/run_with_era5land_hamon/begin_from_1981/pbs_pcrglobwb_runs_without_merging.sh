...
INI_FILE=${PBS_O_WORKDIR}/setup_6arcmin_era5land_hamon_version_develop.ini


# set the output folder
MAIN_OUTPUT_DIR="/scratch/ms/copext/cyes/pcrglobwb_output_era5land_version_develop/version_2020-10-18_with_hamon/begin_from_1981/"
