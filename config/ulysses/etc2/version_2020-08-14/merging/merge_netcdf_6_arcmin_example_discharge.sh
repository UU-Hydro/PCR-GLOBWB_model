...
python3 merge_netcdf_6_arcmin_ulysses.py ${MAIN_OUTPUT_DIR} ${MAIN_OUTPUT_DIR}/global/netcdf outMonthAvgNC ${STARTING_DATE} ${END_DATE} discharge,totalWaterStorageThickness NETCDF4 False 8 Global
