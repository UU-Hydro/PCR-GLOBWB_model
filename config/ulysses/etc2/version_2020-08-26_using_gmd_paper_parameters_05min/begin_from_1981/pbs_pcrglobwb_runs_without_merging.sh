...
INI_FILE=${PBS_O_WORKDIR}/setup_05min_global_gmd_paper_with_era5land.ini

# set the output folder
MAIN_OUTPUT_DIR="/scratch/ms/copext/cyes/pcrglobwb_output/pcrglobwb_output_version_2020-08-26_using_gmd_paper_parameters_05min/begin_from_1981/"
