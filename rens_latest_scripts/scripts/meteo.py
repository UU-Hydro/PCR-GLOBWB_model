...
class Meteo(object):
    ...
    def __init__(self,iniItems,landmask,spinUp):
        ...
        self.preConst= iniItems.meteoOptions['precipitationConstant']
        self.preFactor= iniItems.meteoOptions['precipitationFactor']
        self.tmpConst= iniItems.meteoOptions['temperatureConstant']
        self.tmpFactor= iniItems.meteoOptions['temperatureFactor']
        self.refETPotConst= iniItems.meteoOptions['referenceEPotConstant']
        self.refETPotFactor= iniItems.meteoOptions['referenceEPotFactor']
        #-variable names      
        self.preVarName= iniItems.meteoOptions['precipitationVariableName']
        self.tmpVarName= iniItems.meteoOptions['temperatureVariableName']
        self.refETPotVarName= iniItems.meteoOptions['referenceEPotVariableName']
        #-----------------------------------------------------------------------
    ...
    def read_forcings(self,currTimeStep):
        ...
        self.precipitation  = float(self.preConst)+float(self.preFactor)*pcr.ifthen(self.landmask, self.precipitation)
        #-----------------------------------------------------------------------
        ...
        self.temperature    = float(self.tmpConst)+float(self.tmpFactor)*pcr.ifthen(self.landmask, self.temperature)
        #-----------------------------------------------------------------------
        ...
        if self.refETPotMethod == 'Input': 
            ...
            self.referencePotET = float(self.refETPotConst)+float(self.refETPotFactor)*pcr.ifthen(self.landmask, self.referencePotET)
            #-----------------------------------------------------------------------
