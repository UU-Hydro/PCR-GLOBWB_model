...
# RvB: variables pertaining to the persistent flooded fraction of natural land, corresponding
# to the potential upper limit of bogs, fens and mires
# persistent saturated fraction 
pcrglobwb_variable_name = 'persistentSaturatedFraction'
netcdf_short_name[pcrglobwb_variable_name] = 'persistentSaturatedFraction'
netcdf_unit[pcrglobwb_variable_name]       = 'm2/m2'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_long_name[pcrglobwb_variable_name]  = 'persistent_saturated_fraction_'
description[pcrglobwb_variable_name]       = None
comment[pcrglobwb_variable_name]           = 'Persistent saturated fraction over natural land cover fraction '
latex_symbol[pcrglobwb_variable_name]      = None

# ponded water depth 
pcrglobwb_variable_name = 'pondedWaterDepth'
netcdf_short_name[pcrglobwb_variable_name] = 'pondedWaterDepth'
netcdf_unit[pcrglobwb_variable_name]       = 'm'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_long_name[pcrglobwb_variable_name]  = 'ponded_water_depth_'
description[pcrglobwb_variable_name]       = None
comment[pcrglobwb_variable_name]           = 'Ponded water depth on persistent saturated fraction over natural land cover fraction '
latex_symbol[pcrglobwb_variable_name]      = None

# runoff depth 
pcrglobwb_variable_name = 'runoffDepthSaturatedFraction'
netcdf_short_name[pcrglobwb_variable_name] = 'runoffDepthSaturatedFraction'
netcdf_unit[pcrglobwb_variable_name]       = 'm/m2.day-1'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_long_name[pcrglobwb_variable_name]  = 'runoff_depth_'
description[pcrglobwb_variable_name]       = None
comment[pcrglobwb_variable_name]           = 'Depth of runoff generated on persistent saturated fraction over natural land cover fraction '
latex_symbol[pcrglobwb_variable_name]      = None

# runoff depth 
pcrglobwb_variable_name = 'runoffDepthOther'
netcdf_short_name[pcrglobwb_variable_name] = 'runoffDepthOther'
netcdf_unit[pcrglobwb_variable_name]       = 'm/m2.day-1'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_long_name[pcrglobwb_variable_name]  = 'runoff_depth_'
description[pcrglobwb_variable_name]       = None
comment[pcrglobwb_variable_name]           = 'Depth of runoff generated over other areas than the persistent saturated fraction over natural land cover fraction '
latex_symbol[pcrglobwb_variable_name]      = None
