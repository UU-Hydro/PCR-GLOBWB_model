...
class mymodflow(DynamicModel):
	...
	def __init__(self, cloneMap, modelTime):
		...
		# make netcdf file    
		outDir	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_human/tmp/"
	...
	def initial (self):
		...
		kvert_l2			= 	cover(kvert_l2,1000)
		kvert_l1			= 	cover(kvert_l1,1000)
		kvert_l1_	=	(kvert_l1/cellarea)
		kvert_l2_	=	(kvert_l1/cellarea)
		pcr.report(kD_l2, "kD_l2.map")
		pcr.report(kD_l1, "kD_l1.map")
		pcr.report(kvert_l1_,"kvert_l1.map")
		pcr.report(kvert_l2_,"kvert_l2.map")
		pcr.report(khoriz_l1,"khoriz_l1.map")
		pcr.report(khoriz_l2,"khoriz_l2.map")
...
#		mf.setStorage(stor_conf, stor_sec,1)							# confined aquifer has storage coefficient unconfined is specific yield
	...
	def dynamic(self):		
		...
		if self.modelTime.isLastDayOfMonth():
			...
			print(dateInput)
			lastDateofFirstMonth = "2000-01-31"  			## FIX ME
			...
			if dateInput == lastDateofFirstMonth:
				...
				##ncFile	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_human/merged/netcdf/discharge_monthAvg_output.nc"     
				varName = 	"discharge"
				...
				##ncFile	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_human/merged/netcdf/gwRecharge_monthAvg_output.nc"     
				...
				##ncFile	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_human/merged/netcdf/totalGroundwaterAbstraction_monthAvg_output.nc"   # unit = [md-1]    
				...
				ncFile		=	"/projects/0/dfguu/users/inge/modflow_coupling_global_human/merged/netcdf/irrGrossDemand_monthTot_output.nc" 
				...
				ncFile		=	"/projects/0/dfguu/users/inge/modflow_coupling_global_human/merged/netcdf/totalPotentialMaximumGrossDemand_monthTot_output.nc" 
				...
				ncFile_nat 		=	"/projects/0/dfguu/users/inge/modflow_coupling_global_human/merged/netcdf/gwRecharge_monthAvg_output.nc"	 	 
				...
				ncFile		=	"/projects/0/dfguu/users/inge/modflow_coupling_global_human/merged/netcdf/totalGroundwaterAbstraction_monthAvg_output.nc" 
				varName		=	"total_groundwater_abstraction"																							
	...
	#		totGWused	=	cover(totGWused* -1.0,0.0)
			...
			pcr.report(water_thickness, "/projects/0/dfguu/users/inge/modflow_coupling_global_human/waterthick.map")
			...
			pcr.report(head_topMF, "/projects/0/dfguu/users/inge/modflow_coupling_global_human/tmp/head_topMF.map")
			pcr.report(head_topMF, "/projects/0/dfguu/users/inge/modflow_coupling_global_human/tmp/ini/head_topMF")
			pcr.report(head_bottomMF, "/projects/0/dfguu/users/inge/modflow_coupling_global_human/tmp/head_bottomMF.map")							## --> can the dir-path be automatic  
			pcr.report(gw_depth2, "/projects/0/dfguu/users/inge/modflow_coupling_global_human/tmp/depth_topMF.map")
			pcr.report(tot_baseflowMF, "/projects/0/dfguu/users/inge/modflow_coupling_global_human/tmp/tot_baseflowMF.map")
			pcr.report(storGW, "/projects/0/dfguu/users/inge/modflow_coupling_global_human/tmp/storage_GWMF.map")
			pcr.report(relativeHead_top, "/projects/0/dfguu/users/inge/modflow_coupling_global_human/tmp/relativeHead_topMF.map")
			...
			outDir	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_human/tmp/"													## --> output dir
			for variable in self.variable_output:
