...
class mymodflow(DynamicModel):
	...
	def initial (self):
		...
		pcr.report(khoriz_l1,"khoriz_l1")
		pcr.report(khoriz_l2,"khoriz_l2")
		pcr.report(kvert_l1,"kvert_l1")
		pcr.report(kvert_l2,"kvert_l2")		
...
#		mf.setStorage(stor_conf, stor_sec,1)							# confined aquifer has storage coefficient unconfined is specific yield
	...
	def dynamic(self):		
		...
		if self.modelTime.isLastDayOfMonth():
			...
			print(dateInput)
			lastDateofFirstMonth = "1986-01-31"  			## FIX ME
