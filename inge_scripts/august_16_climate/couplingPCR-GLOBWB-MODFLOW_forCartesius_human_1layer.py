...
for fileName in firstInitialConditionFileListMF: 
	...
	#'cp /projects/0/dfguu/users/inge/inputMAPS/steadyState_MF/*.map -d /projects/0/dfguu/users/inge/modflow_coupling_global_human/tmp/ini/'
...
for i_date in range(1, modelTime.nrOfTimeSteps+1):
    ...
    if modelTime.isFirstDayOfMonth():
        ...
        lastDateofFirstMonth = "1960-01-31"							## ** FIX ME!!	#<=========================================
