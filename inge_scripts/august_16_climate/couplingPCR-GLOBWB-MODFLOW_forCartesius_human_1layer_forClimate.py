...
for fileName in firstInitialConditionFileListMF: 
	cmd	= 'cp /home/inge/MODFLOW_coupled_TEST/iniCondClimate/*.map -d /projects/0/dfguu/users/inge/modflow_coupling_global_human_Climate/tmp/ini'
...
vos.cmd_line(cmd, using_subprocess = False)
cmd	= 'cp /projects/0/dfguu/users/inge/modflow_coupling_global_human_Climate/tmp/ini/head_topMF.map -d /projects/0/dfguu/users/inge/modflow_coupling_global_human_Climate/'
vos.cmd_line(cmd, using_subprocess = False)

for fileName in firstInitialConditionFileListMF: 
	cmd	= 'cp /home/inge/MODFLOW_coupled_TEST/extrainputs/*.map -d /projects/0/dfguu/users/inge/modflow_coupling_global_human_Climate/tmp/ini/'
logger.info("Creating the master ini file for MODFLOW runs.")
vos.cmd_line(cmd, using_subprocess = False)
