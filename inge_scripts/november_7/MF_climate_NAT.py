...
class mymodflow(DynamicModel):
	...
	def __init__(self, cloneMap, modelTime):
		...
		# make netcdf file    
		outDir	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural/tmp/"
...
#		mf.setStorage(stor_conf, stor_sec,1)							# confined aquifer has storage coefficient unconfined is specific yield
	...
	def dynamic(self):		
		...
		if self.modelTime.isLastDayOfMonth():
			...
			if dateInput == lastDateofFirstMonth:
				...
				ncFile	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural/merged/netcdf/discharge_monthAvg_output.nc"     
				#ncFile	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural/merged/netcdf/discharge_monthAvg_output.nc " 
				varName = 	"discharge"
				print(ncFile)
				...
				ncFile	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural/merged/netcdf/gwRecharge_monthAvg_output.nc"     
				#ncFile = 	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural/merged/netcdf/gwRecharge_monthAvg_output.nc " 
				print(ncFile)
			...
			#	ncFile	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural/merged/netcdf/totalGroundwaterAbstraction_monthAvg_output.nc"   # unit = [md-1]    
			...
			#	ncFile		=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural/merged/netcdf/irrGrossDemand_monthTot_output.nc" 
			...
			#	ncFile		=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural/merged/netcdf/totalPotentialMaximumGrossDemand_monthTot_output.nc" 
			...
			#							cloneMapFileName = self.cloneMap) 						
				...
				ncFile_nat 		=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural/merged/netcdf/gwRecharge_monthAvg_output.nc"	 	 
	...
	#		totGWused	=	cover(totGWused* -1.0,0.0)
			...
			#pcr.report(water_thickness, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural/waterthick.map")
			...
			pcr.report(head_topMF, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural/tmp/head_topMF.map")
			pcr.report(head_topMF, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural/tmp/ini/head_topMF")
			pcr.report(head_bottomMF, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural/tmp/head_bottomMF.map")							## --> can the dir-path be automatic  
			pcr.report(gw_depth2, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural/tmp/depth_topMF.map")
			pcr.report(tot_baseflowMF, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural/tmp/tot_baseflowMF.map")
			pcr.report(storGW, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural/tmp/storage_GWMF.map")
			pcr.report(relativeHead_top, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural/tmp/relativeHead_topMF.map")
			...
			outDir	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural/tmp/"													## --> output dir
			for variable in self.variable_output:
