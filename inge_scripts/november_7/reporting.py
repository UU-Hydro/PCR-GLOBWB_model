...
class Reporting(object):
    ...
    def additional_post_processing(self):
        ...
        # Inge's postprocessing  DOES NOT WORK; DON'T KNOW WHY NOT ....
        self.unsatisfiedDemand = self._model.landSurface.totalPotentialMaximumGrossDemand - \
                                 self._model.landSurface.allocSurfaceWaterAbstract - \
                                 self._model.landSurface.allocNonFossilGroundwater - \
                                 self._model.landSurface.desalinationAllocation 
                                 #- \
                                 #self._model.landSurface.fossilGroundwaterAlloc  
        # note that fossil = 0 when using modflow                                 
        
        ## this also does not work ......       
        self.allocSurfaceWaterAbstract        = self._model.landSurface.allocSurfaceWaterAbstract
        self.allocNonFossilGroundwater        = self._model.landSurface.allocNonFossilGroundwater
        self.desalinationAllocation           = self._model.landSurface.desalinationAllocation
        self.totalPotentialMaximumGrossDemand = self._model.landSurface.totalPotentialMaximumGrossDemand
