...
#print(firstInitialConditionFileList)
...
master_ini_file= generalOutputFolder+ "/tmp/setup_prcglobwb.ini" 
...
for fileName in firstInitialConditionFileListMF: 
	cmd	= 'cp /home/inge/MODFLOW_coupled_TEST/iniCondClimate/*.map -d /projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/tmp/ini'
#	cmd	= 'cp /projects/0/dfguu/users/inge/inputMAPS/steadyState_MF/*.map -d /projects/0/dfguu/users/inge/modflow_coupling_global_human_Climate/tmp/ini/'
logger.info("Creating the master ini file for MODFLOW runs.")
vos.cmd_line(cmd, using_subprocess = False)
cmd	= 'cp /projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/tmp/ini/head_topMF.map -d /projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/'
vos.cmd_line(cmd, using_subprocess = False)

for fileName in firstInitialConditionFileListMF: 
	cmd	= 'cp /home/inge/MODFLOW_coupled_TEST/extrainputs/*.map -d /projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/tmp/ini/'
logger.info("Creating the master ini file for MODFLOW runs.")
vos.cmd_line(cmd, using_subprocess = False)
