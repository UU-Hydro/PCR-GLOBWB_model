...
GCM_CODE="gfdl-esm4" 
GCM_CODE_SHORT="gfdl"
python merging_daily_variables.py /ssp_disks/links_to_ssps_all/${GCM_CODE_SHORT}/pcrglobwb/pcrglobwb_output/pcrglobwb_aqueduct_2021/version_2021-09-16/${GCM_CODE}/historical/ 1960 2014 /ssp_disks/links_to_ssps_all/${GCM_CODE_SHORT}/pcrglobwb/merged_daily/pcrglobwb_aqueduct_2021/version_2021-09-16/${GCM_CODE}/historical/begin_from_1960/global/netcdf_daily/ &
...
#~ (base) pcrglobwb-azure@pcrglobwb-azure:/ssp_disks/links_to_ssps_all/gfdl/pcrglobwb/merged_daily/pcrglobwb_aqueduct_2021/version_2021-09-16/gfdl-esm4/historical/begin_from_1960/global/netcdf_daily$ ls -lah /ssp_disks/links_to_ssps_all/*/pcrglobwb/pcrglobwb_output/pcrglobwb_aqueduct_2021/version_2021-09-16/* -d
