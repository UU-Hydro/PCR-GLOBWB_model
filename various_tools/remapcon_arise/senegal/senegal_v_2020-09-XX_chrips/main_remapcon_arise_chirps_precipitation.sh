...
bash remapcon_arise.sh ${INP_FOLDER}/chirps_rainfall/SNL_chirps-v2.0.1981-2020.days_p05.nc ${RESOLUTION} ${OUT_FOLDER} senegal_chirps-v2.0_1981-2020_p05_rempacon-30-arcmin monsum mm.month-1
...
bash remapcon_arise.sh ${INP_FOLDER}/chirps_rainfall/SNL_chirps-v2.0.1981-2020.days_p05.nc ${RESOLUTION} ${OUT_FOLDER} senegal_chirps-v2.0_1981-2020_p05_rempacon-5-arcmin monsum mm.month-1
...
bash remapcon_arise.sh ${INP_FOLDER}/chirps_rainfall/SNL_chirps-v2.0.1981-2020.days_p05.nc ${RESOLUTION} ${OUT_FOLDER} senegal_chirps-v2.0_1981-2020_p05_rempacon-150-arcsec monsum mm.month-1
