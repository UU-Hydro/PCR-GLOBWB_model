...
CLONE30SEC="/rds/general/user/esutanud/ephemeral/data/pcrglobwb_input_arise/develop/pcrglobwb2_input/global_30sec/cloneMaps/senegal/clone_basins_of_senegal_167_gambia_72.map"

#~ (pcrglobwb_python3) esutanud@login-7:/rds/general/user/esutanud/ephemeral/data/pcrglobwb_input_arise/develop/pcrglobwb2_input/global_30sec/cloneMaps/senegal$ ls -lah *
#~ -rw-r--r-- 1 esutanud hpc-ec407 1.5M May 18 15:12 clone_basins_of_senegal_167_gambia_72.map
...
#~ # check
#~ pwd
#~ ncview ${OUTPUT_DAILY_FILE} &
#~ ncview ${OUTPUT_MONTH_FILE} &
wait
