...
class LandCover(object):
    ...
    def estimate_paddy_infiltration_loss(self,parameters):
        ...
        if self.name == 'irrPaddy':
            ...
            max_percolation_loss = 0.008 # 0.008         # unit: m/day
            #
    ...
    def calculateInfiltration(self, parameters):
        ...
        if self.name == 'irrPaddy':
            ...
            #~ # option 2: infiltration rate depend on the maximum from design_percolation_loss and potential_irrigation_loss (irrigation efficiency)
            #~ self.infiltration = pcr.ifthenelse(self.cropKC > 0.75, \
                                               #~ pcr.min(pcr.max(self.design_percolation_loss,self.potential_irrigation_loss), self.infiltration), self.infiltration)
            # option 3: infiltration rate depend on the potential_irrigation_loss (irrigation efficiency)
            self.infiltration = pcr.ifthenelse(self.cropKC > 0.75, \
