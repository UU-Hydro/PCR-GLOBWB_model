...
output_dir="/scratch/jong0137/pcr_globwb/pcraster/30min_global/"
...
if [[ $hostname == "orkney" ]];
then
     scratch_prefix="/media/data/scratch/kor"
     input_prefix="$scratch_prefix/data"
     libtcmalloc="/usr/lib/x86_64-linux-gnu/libtcmalloc_minimal.so.4"
elif [[ $hostname == "velocity" ]];
then
     scratch_prefix="/scratch/jong0137"
     input_prefix="/data"
