...
mapattr -s -P yb2t -R 20000 -C 40000 -B -x -18 -y 38 -l 0.000833333 /scratch/depfg/sutan101/clone_map_for_lue/clone_map_for_lue_test.map
...
LUE_PARTITION_SHAPE="12000,15000" \
