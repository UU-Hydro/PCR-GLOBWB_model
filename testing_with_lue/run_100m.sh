...
pcrglobwb_runner="/eejit/home/sutan101/github/UU-Hydro/PCR-GLOBWB_model/model/deterministic_runner_lue.py"
pcrglobwb_ini="/eejit/home/sutan101/github/UU-Hydro/PCR-GLOBWB_model/config/lue/setup_100m_for_lue_experiment_v2025-05-15.ini"
...
LUE_PARTITION_SHAPE="10,20" \
     python ${pcrglobwb_runner} ${pcrglobwb_ini} ${pcrglobwb_debug_mode} \
         ...
         --lue:count=1 \
         --lue:nr_workers=1 \
         --lue:array_shape="10,20" \
         --lue:partition_shape="10,20" \
