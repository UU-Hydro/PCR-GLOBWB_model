# Inge de Graaf ; scrip as used for last chapter thesis, with climate inputs (= same as WRR)
...
class mymodflow(DynamicModel):
	...
	def __init__(self, cloneMap, modelTime):
		...
		# make netcdf file    
		outDir	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/tmp/"
	...
	def initial (self):
		...
		iHeadini		=	self.readmap("/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/head_topMF")		
		# maps
...
#		mf.setStorage(stor_conf, stor_sec,1)							# confined aquifer has storage coefficient unconfined is specific yield
	...
	def dynamic(self):		
		...
		if self.modelTime.isLastDayOfMonth():
			...
			print(dateInput)
			lastDateofFirstMonth = "2006-05-31" #"1960-01-31"  			## FIX ME
			...
			if dateInput == lastDateofFirstMonth:
				...
				ncFile	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_human_Climate/merged/netcdf/discharge_monthAvg_output.nc"     
				varName = 	"discharge"
				...
				ncFile	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_human_Climate/merged/netcdf/gwRecharge_monthAvg_output.nc"     
				...
				ncFile	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_human_Climate/merged/netcdf/totalGroundwaterAbstraction_monthAvg_output.nc"   # unit = [md-1]    
				...
				#ncFile		=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/merged/netcdf/totalPotentialMaximumGrossDemand_monthTot_output.nc" 
				...
				ncFile	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/merged/netcdf/discharge_monthAvg_output.nc"     
				##ncFile	=	"/projects/0/dfguu/users/inge/inputMAPS/maps__/discharge_hum_monthAvg_output.nc"
				varName = 	"discharge"
				...
				ncFile_nat 		=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/merged/netcdf/gwRecharge_monthAvg_output.nc"	 	 
				...
				ncFile		=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/merged/netcdf/totalGroundwaterAbstraction_monthAvg_output.nc" 
				varName		=	"total_groundwater_abstraction"																							
				...
				#- FOR ABSTRACTION RATIO
				#- Irrigation gross demand
				#ncFile		=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/merged/netcdf/irrGrossDemand_monthTot_output.nc" 
				#varName		=	"irrigation_gross_demand"																							
				#irrDemand	=	vos.netcdf2PCRobjClone(ncFile,varName,dateInput,\
				#						useDoy = None,
				#						cloneMapFileName = self.cloneMap) 
			...
			totGWused_m3d	=	scalar(0) #cover((totGW*self.cellarea),0.0)
			
			rch_cor_m3d		=	max(0.0, rch_m3d- totGWused_m3d)
	...
	#		totGWused	=	cover(totGWused* -1.0,0.0)
			...
			pcr.report(water_thickness, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/waterthick.map")
			...
			pcr.report(head_topMF, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/tmp/head_topMF.map")
			pcr.report(head_topMF, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/tmp/ini/head_topMF")
			pcr.report(head_bottomMF, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/tmp/head_bottomMF.map")							## --> can the dir-path be automatic  
			pcr.report(gw_depth2, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/tmp/depth_topMF.map")
			pcr.report(tot_baseflowMF, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/tmp/tot_baseflowMF.map")
			pcr.report(storGW, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/tmp/storage_GWMF.map")
			pcr.report(relativeHead_top, "/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/tmp/relativeHead_topMF.map")
			...
			outDir	=	"/projects/0/dfguu/users/inge/modflow_coupling_global_natural_Climate/tmp/"													## --> output dir
			for variable in self.variable_output:
