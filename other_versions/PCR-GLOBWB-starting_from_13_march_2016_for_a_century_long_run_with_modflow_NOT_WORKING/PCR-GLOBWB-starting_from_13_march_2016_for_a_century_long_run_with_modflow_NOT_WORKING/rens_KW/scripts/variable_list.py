...
# inundation depth
pcrglobwb_variable_name = 'InundationDepth'
netcdf_short_name[pcrglobwb_variable_name] = 'InundationDepth'
netcdf_unit[pcrglobwb_variable_name]       = 'm'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_long_name[pcrglobwb_variable_name]  = 'Inundation_Depth_Floodplain'
description[pcrglobwb_variable_name]       = None
comment[pcrglobwb_variable_name]           = 'Inundation Depth is a combination of dynamic water fraction and floodplain'
latex_symbol[pcrglobwb_variable_name]      = None
