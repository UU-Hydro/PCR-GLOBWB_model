...
class Configuration(object):
    ...
    def repairGroundwaterOptions(self):
        ...
        if 'minRecessionCoeff' not in self.groundwaterOptions.keys():
            ...
            msg += 'This run assumes "1.0e-4" for this option.'
            logger.warning(msg)
        ...
        if 'maximumDailyFossilGroundwaterAbstraction' not in self.groundwaterOptions.keys():
            ...
            #~ msg += 'This run assumes "0.020 m/day" for this option.'                                   # old version
            msg    += 'This run uses the same value as defined in "maximumDailyGroundwaterAbstraction".'
            logger.warning(msg)
            #~ self.groundwaterOptions['maximumDailyFossilGroundwaterAbstraction'] = "0.020"              # old option
            self.groundwaterOptions['maximumDailyFossilGroundwaterAbstraction']    = self.groundwaterOptions['maximumDailyGroundwaterAbstraction']
