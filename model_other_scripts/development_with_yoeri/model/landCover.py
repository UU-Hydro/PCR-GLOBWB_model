        ...
        if date_in_string != None: 
		    ...
		    print "file = " + netcdf_file
                    ...
                    try:
                        ...
                        print "ini=" + str(ini_option)
                        print "clone=" + str(self.cloneMap)
                        print "tmpdir=" + str(self.tmpDir)
                        print "inpdir=" + str(self.inputDir)
...
#~ 
    ...
    def calculateWaterDemand(self, nonIrrGrossDemandDict, \
        ...
        #TEMP FIX. Fill in classes that are supposed to be irrigated here to include them in the demend. 
        #Permanent fix = make option per class to irrigate? (Yoeri)
        temp_fix_irrigated_classes =  ['irrNonPaddy', \
                                       'irr_non_paddy', \
                                       'irr_non_paddy_crops', \
                                       'irrSugarCane', \
                                       'irrigatedNonPaddy']  
        ...
        if self.name in temp_fix_irrigated_classes: self.totalPotentialMaximumIrrGrossDemandNonPaddy = self.irrGrossDemand
        ...
        if self.name in temp_fix_irrigated_classes: self.irrGrossDemandNonPaddy = self.irrGrossDemand
