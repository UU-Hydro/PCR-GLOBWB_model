...
class ModelTime(object):
    ...
    def isFirstDayOfWeek(self):
        #return self.currTime.weekday()==0
        return self.doy%7==1

    def isLastDayOfWeek(self):
        #return self.currTime.weekday()==6
        return self.doy%7==0

    # add shorter "week" for the first days of reporting?
    def weekLength(self):
        self._weekLength=7
        print('Week length printing %s %s' %(self.weekLength,type(self.weekLength)))
    ...
    @property
    def beginWeek(self):
        return self.isFirstDayOfWeek()

    @property
    def endWeek(self):
        return self.isLastDayOfWeek()
