...
# fraction of surface water (this includes channelFraction and floodFrac - when using simplifiedKinematicWave -) 
...
# channel fraction (computed using avgDischarge) 
pcrglobwb_variable_name = 'channelFraction'
netcdf_short_name[pcrglobwb_variable_name] = 'fraction_of_channel'
netcdf_unit[pcrglobwb_variable_name]       = '1'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_long_name[pcrglobwb_variable_name]  = None
description[pcrglobwb_variable_name]       = None
comment[pcrglobwb_variable_name]           = 'Fraction of channel within the cell area.'
latex_symbol[pcrglobwb_variable_name]      = None
...
############### Added for water temperature computations#########################
# Water temperature
