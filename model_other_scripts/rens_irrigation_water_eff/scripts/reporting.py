...
class Reporting(object):
    ...
    def additional_post_processing(self):
        ...
        #-actual and potential evapotranspiration from land cover types (added by Rens)
        self.grasslandPotentialET = self._model.landSurface.landCoverObj['grassland'].totalPotET
        self.grasslandActualET =    self._model.landSurface.landCoverObj['grassland'].actualET
        self.forestPotentialET =    self._model.landSurface.landCoverObj['forest'].totalPotET
        self.forestActualET =       self._model.landSurface.landCoverObj['forest'].actualET
